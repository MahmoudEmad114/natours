...
/*
// How JSON WEB TOKEN (JWT) Auth Works
                   CLIENT                               SERVER
L                    |                                    |
O                    | --(1)POST /login {email,pass} ---> | (2) if user 
G                    |                                    | && pass,
I  (4)Store JWT      |<--(3)JWT-------------------------- | create Unique
N  (cookie or        |                                    | JWT(secret)
    localStorage)    |                                    |
A                    |                                    | 
C                    |                                    |
c                    |                                    |
e                    |--(5)GET /someProtectRoute(JWT) --> | (6) if valid
s                    | HTTPS                              | JWT, allow 
s                    |<--(7)ProtectedDATA --------------- | access
