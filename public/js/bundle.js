...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    // GeoJSON: [lng, lat]
    // Leaflet: [lat, lng]
    var coordinates = [loc.coordinates[1], loc.coordinates[0]];
...
function resolveConfig(config) {
  ...
  if (_utils.default.isFormData(data)) {
    if (_index.default.hasStandardBrowserEnv || _index.default.hasStandardBrowserWebWorkerEnv || _utils.default.isReactNative(data)) {
      ...
      (0, _setFormDataHeaders.default)(headers, data.getHeaders(), own('formDataHeaderPolicy'));
    }
  }
...
const VERSION = exports.VERSION = "1.19.0";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Singed up successfully!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51U7d4MHWpbGXNWcAinD5wXYVjVulzdOAtrvZxhqG1uVVYIDa7ZYpbedfmHHRa45DjKL6eFfkYeGBrKsrHTotR2vc002Iw8Vzfa');
